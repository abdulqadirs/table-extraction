...
class CPN(nn.Module):
    ...
    def __init__(self, input_channels, max_pooling, sigmoid):
        ...
        self.projection_pooling_features = ProjectionPooling(direction=1)
        self.projection_pooling_predictions = nn.Sequential(ProjectionPooling(direction=1), nn.Sigmoid())
